...
- [x] `winget install --id Python.Python.3.10 -e` → Python 3.10.11 (2026-07-17)
- [x] `winget install --id Gyan.FFmpeg -e` → FFmpeg 8.1.2 (2026-07-17)
- [x] Tạo `CLAUDE.md` + `.claude/plan/*.md` (tổ chức lại toàn bộ kế hoạch, 2026-07-17)
- [ ] `git init` tại thư mục gốc + tạo `.gitignore` + commit khởi tạo
- [ ] Tạo venv `backend\.venv`, kích hoạt
- [ ] `pip install -r requirements.txt -r requirements-dev.txt`, xác nhận cài thành công (đặc biệt `basic-pitch` dùng `onnxruntime`, không kéo TensorFlow)
